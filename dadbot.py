...
def respond_trigger_words(update,triggers,responses):
...
def respond_trigger_words_user(update,triggers,responses,userid):
    text = strip_punct(update["message"]["text"])
    chat = update["message"]["chat"]["id"]
    b = True
    for ands in triggers:
